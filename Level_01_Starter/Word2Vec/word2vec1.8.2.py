...
if __name__ == '__main__':
    ...
    myDataLoader = DataLoader(myDataset, batch_size=batch_size, shuffle=False, collate_fn=collateFn)
    ...
    for e in range(epoch):
        ...
        for currWordsOneHot, neighborsOneHot in tqdm(myDataLoader):
            currWordsOneHot = currWordsOneHot.to(device)
            neighborsOneHot = neighborsOneHot.to(device)
            if MODEL == "cbow":
